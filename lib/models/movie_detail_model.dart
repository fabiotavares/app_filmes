...
class MovieDetailModel {
  ...
  factory MovieDetailModel.fromMap(Map<String, dynamic> map) {
    // obtendo a lista de imagens que está dentro da estrutura do json recebido (ver postman para entender)
    var urlImamgesPosters = map['images']['posters'];
    var urlImages =
        (urlImamgesPosters?.map<String>((i) => 'https://image.tmdb.org/t/p/w200${i['file_path'] ?? ''}').toList()) ??
            const [];
